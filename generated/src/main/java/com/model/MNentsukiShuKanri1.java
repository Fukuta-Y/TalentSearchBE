 ...
 * 年月週管理マスタ情報（全列）
 */
@Schema(name = "mNentsukiShuKanri_1", description = "年月週管理マスタ情報（全列）")
@JsonTypeName("mNentsukiShuKanri_1")
@Generated(
    value = "org.openapitools.codegen.languages.SpringCodegen", date = "2023-10-24T18:28:20.250886+09:00[Asia/Tokyo]"
)
public class MNentsukiShuKanri1
{
    ...
    public MNentsukiShuKanri1 nentsuki(Integer nentsuki)
    {
    ...
    public MNentsukiShuKanri1 shu(Integer shu)
    {
        this.shu = shu;
        return this;
    }
    ...
    public MNentsukiShuKanri1 shuFrom(String shuFrom)
    {
    ...
    public MNentsukiShuKanri1 shuTo(String shuTo)
    {
        this.shuTo = shuTo;
        return this;
    }
    ...
    public MNentsukiShuKanri1 torokuDay(String torokuDay)
    {
    ...
    public MNentsukiShuKanri1 koushinDay(String koushinDay)
    {
    ...
    public boolean equals(Object o)
    {
        ...
        MNentsukiShuKanri1 mNentsukiShuKanri1 = (MNentsukiShuKanri1) o;
        return Objects.equals(this.nentsuki, mNentsukiShuKanri1.nentsuki) &&
            Objects.equals(this.shu, mNentsukiShuKanri1.shu) &&
            Objects.equals(this.shuFrom, mNentsukiShuKanri1.shuFrom) &&
            Objects.equals(this.shuTo, mNentsukiShuKanri1.shuTo) &&
            Objects.equals(this.torokuDay, mNentsukiShuKanri1.torokuDay) &&
            Objects.equals(this.koushinDay, mNentsukiShuKanri1.koushinDay);
    }
    ...
    public String toString()
    {
        ...
        sb.append("class MNentsukiShuKanri1 {\n");
