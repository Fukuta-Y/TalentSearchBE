...
public interface NentsukiShuKanriApi
{
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(
                responseCode = "200", description = "年月週管理マスタDTOの情報", content = {
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(
                responseCode = "200", description = "登録または更新した年月週管理マスタDTOの情報", content = {
                    @Content(mediaType = "application/json", schema = @Schema(implementation = NentsukiShuKanri.class))
                }
            )
        }
    ...
    ResponseEntity<NentsukiShuKanri> postProgramTorokuKoshin(
        @Parameter(name = "MNentsukiShuKanri", description = "年月週管理マスタ情報を登録または更新する") @Valid @RequestBody(
            required = false
        ) MNentsukiShuKanri mnentsukiShuKanri
    );
}
